...
public class Picture extends SimplePicture 
{
  ...
  public void c0py(Picture fromPic, int startRow, int endRow, int endCol, int startCol)
  {
    Pixel fromPixel = null;
    Pixel toPixel = null;
    Pixel[][] toPixels = this.getPixels2D();
  ...
  public void myCollage()
  {
    ...
    this.copy(kitten2,0,0);
    this.copy(flower1,100,0);
    this.copy(swan,200,0);
	
    Picture zerobluekitty = new Picture(kitten2);
    zerobluekitty.zeroBlue();
	
	Picture sadflower = new Picture(flower1);
    flower1.grayscale();
	
	Picture blueswan = new Picture(swan);
    swan.keepOnlyBlue();
	
    this.copy(zerobluekitty,300,0);
    this.copy(sadflower,400,0);
    this.copy(blueswan,500,0);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
